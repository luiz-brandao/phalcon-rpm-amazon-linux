...
#
# Modificated for Amazon Linux by fromvega 
# https://github.com/fromvega/phalcon-rpm-amazon-linux
#

# In Amazon Linux, the following macros are defined in the following file
# %{_rpmconfigdir}/macros.php-5.5
# I just copy pasted them and adjusted to follow the rest of the SPEC pattern
#
%global php_core_api    20121113-64
%global php_zend_api    20121212-64
%global php_pdo_api     20080721-64
%global php_version     5.5.22

%global php_extdir      %{_libdir}/php/5.5/modules
%global php_ztsextdir   %{_libdir}/php-zts/5.5/modules

%global php_inidir      %{_sysconfdir}/php-5.5.d
%global php_ztsinidir   %{_sysconfdir}/php-zts-5.5.d

%global php_incldir     %{_includedir}/php/5.5
%global php_ztsincldir  %{_includedir}/php-zts/5.5/php

%global __php           %{_bindir}/php-5.5
%global __phpconfig     %{_bindir}/php-config-5.5
%global __phpize        %{_bindir}/phpize-5.5

%global __ztsphp        %{_bindir}/zts-php-5.5
%global __ztsphpconfig  %{_bindir}/zts-php-config-5.5
%global __ztsphpize     %{_bindir}/zts-phpize-5.5
